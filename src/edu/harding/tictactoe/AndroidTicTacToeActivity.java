...
public class AndroidTicTacToeActivity extends Activity {
	...
	private void startNewGame(){
		...
		if (turn) {
			...
			AndroidTicTacToeActivity.mInfoTextView.setText(R.string.turn_human);
			turn = true;
		}
	}
	...
	private OnTouchListener mTouchListener = new OnTouchListener() {
		public boolean onTouch(View v, MotionEvent event) {
			...
			if(winner == 0){
				...
				nTie++; 
				mTie.setText("Ties: "+ nTie);
				lockBoard();
			}else if (winner == 2){
				nHumanWin++;
				mHuman_win.setText("Human: "+ nHumanWin);
	...
	private void displayScores() {
		mHuman_win.setText("Human: "+Integer.toString(nHumanWin));
		mComputer_win.setText("Andriod: "+Integer.toString(nComputerWin));
		mTie.setText("Ties: "+Integer.toString(nTie));
	}
